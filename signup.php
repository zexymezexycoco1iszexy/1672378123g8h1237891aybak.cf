...
<script src="https://www.google.com/recaptcha/enterprise.js?render=6Le_HHMkAAAAAKkClPSCaVtoKadVN_7AS0Aj8z2A"></script>
<script>
grecaptcha.enterprise.ready(function() {
    grecaptcha.enterprise.execute('6Le_HHMkAAAAAKkClPSCaVtoKadVN_7AS0Aj8z2A', {action: 'login'}).then(function(token) {
       ...
    });
});
</script>
  
        <input class="submit-btn" id="button" type="submit" value="Sign up">
      
       <a href="login.php" class="link">Already Have An Account? Login</a><br>
   </form>
